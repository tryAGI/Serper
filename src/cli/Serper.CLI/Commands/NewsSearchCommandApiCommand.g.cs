...
internal static partial class NewsSearchCommandApiCommand
{
    ...
    private static Option<bool?> Autocorrect { get; } = CliRuntime.CreateNullableBoolOption(
        ...
        description: @"Whether to autocorrect the query spelling.");
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Serper.NewsSearchResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Serper.NewsSearchResponse value, ref string? text);
