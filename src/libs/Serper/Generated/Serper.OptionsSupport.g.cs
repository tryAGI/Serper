...
namespace Serper
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Serper.AutoSDKRetryOptions Retry { get; set; } = new global::Serper.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Serper.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Serper.IAutoSDKHook>();
        ...
        public global::Serper.AutoSDKClientOptions AddHook(
            global::Serper.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Serper.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Serper.AutoSDKClientOptions UseAuthorizationProvider(
            global::Serper.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Serper.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Serper.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Serper.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Serper.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Serper.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Serper.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Serper.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Serper.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Serper.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Serper.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Serper.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Serper.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Serper.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Serper.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Serper.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Serper.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Serper.AutoSDKClientOptions clientOptions,
            global::Serper.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Serper.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Serper.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Serper.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Serper.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Serper.IAutoSDKHook, global::Serper.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Serper.AutoSDKHookContext context)
        {
