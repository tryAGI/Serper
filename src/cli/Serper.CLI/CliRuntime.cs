...
namespace Serper.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Serper.CLI";
    private const string UserSecretApiKeyName = "SERPER_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"SERPER_API_KEY"];
    private const string CredentialFileDirectoryName = ".serper";

    public static async global::System.Threading.Tasks.Task<global::Serper.SerperClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Serper.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Serper.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "ApiKey",
        ...
        return new global::Serper.SerperClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Serper.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Serper.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Serper.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Serper.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("SERPER_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Serper.ApiException exception)
    {
        var builder = new StringBuilder();
