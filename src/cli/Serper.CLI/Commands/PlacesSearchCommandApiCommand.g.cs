...
internal static partial class PlacesSearchCommandApiCommand
{
    ...
    private static Option<bool?> Autocorrect { get; } = CliRuntime.CreateNullableBoolOption(
        ...
        description: @"Whether to autocorrect the query spelling.");
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Serper.PlacesSearchResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Serper.PlacesSearchResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.PlacesSearchAsync(
                                    q: q,
                                    gl: gl,
                                    hl: hl,
                                    num: num,
