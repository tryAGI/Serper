...
namespace Serper
{
    public partial class SerperClient
    {
        ...
        private static readonly global::Serper.EndPointSecurityRequirement s_PatentSearchSecurityRequirement0 =
        ...
        private static readonly global::Serper.EndPointSecurityRequirement[] s_PatentSearchSecurityRequirements =
            new global::Serper.EndPointSecurityRequirement[]
            {                s_PatentSearchSecurityRequirement0,
            };
        partial void PreparePatentSearchArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Serper.PatentSearchRequest request);
        partial void PreparePatentSearchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Serper.PatentSearchRequest request);
        partial void ProcessPatentSearchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPatentSearchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Serper.PatentSearchResponse> PatentSearchAsync(

            global::Serper.PatentSearchRequest request,
            global::Serper.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PatentSearchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Serper.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Serper.AutoSDKHttpResponse<global::Serper.PatentSearchResponse>> PatentSearchAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Serper.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PatentSearchSecurityRequirements,
                operationName: "PatentSearchAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Serper.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Serper.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PatentSearchAsync",
                                pathTemplate: "\"/patents\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Serper.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatentSearchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Serper.PatentSearchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Serper.AutoSDKHttpResponse<global::Serper.PatentSearchResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Serper.PatentSearchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Serper.PatentSearchResponse> PatentSearchAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Serper.PatentSearchRequest(
            ...
            return await PatentSearchAsync(
                request: __request,
                requestOptions: requestOptions,
