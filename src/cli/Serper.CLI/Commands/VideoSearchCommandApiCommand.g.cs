...
internal static partial class VideoSearchCommandApiCommand
{
    ...
    private static Option<bool?> Autocorrect { get; } = CliRuntime.CreateNullableBoolOption(
        ...
        description: @"Whether to autocorrect the query spelling.");
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Serper.VideoSearchResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Serper.VideoSearchResponse value, ref string? text);
